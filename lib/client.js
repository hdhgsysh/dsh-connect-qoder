window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		async function writeSettingsField(scope, field, value) {
			...
			if (scopeDelivered) {
				// Read back exactly what was stored: the merged `nextValue` for
				// the per-region field, the whole value otherwise.
				...
				if (matches || authoritative !== null) return authoritative;
			}
